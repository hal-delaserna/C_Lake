...
/* TB_FonteCaptacaoPropriaAgrupamentoEmpreendimento as TFCPAE */
 TFCPAE.[IDTipoFonteCaptacaoPropria]
,TFCPAE.[IDAgrupamentoEmpreendimentoBalancoHidrico]
,TFCPAE.[QTCaptacaoAnoBase]

/* TB_TipoFonteCaptacaoPropria as TTFCP */
,TTFCP.[IDTipoFonteCaptacaoPropria] /*pk*/
,TTFCP.[DSTipoFonteCaptacaoPropria]
...
FROM [dbo].[TB_FonteCaptacaoPropriaAgrupamentoEmpreendimento] AS TFCPAE

INNER JOIN [dbo].[TB_AgrupamentoEmpreendimentoBalancoHidrico] as TAEBH
	ON (TFCPAE.[IDAgrupamentoEmpreendimentoBalancoHidrico] = TAEBH.[IDAgrupamentoEmpreendimentoBalancoHidrico])

INNER JOIN [dbo].[TB_TipoFonteCaptacaoPropria] as TTFCP
	ON (TFCPAE.[IDTipoFonteCaptacaoPropria] = TTFCP.[IDTipoFonteCaptacaoPropria])
	
INNER JOIN [dbo].[TB_EmpreendimentoBalancoHidrico] as TEBH
	ON (TFCPAE.[IDAgrupamentoEmpreendimentoBalancoHidrico] = TEBH.[IDAgrupamentoEmpreendimentoBalancoHidrico])
